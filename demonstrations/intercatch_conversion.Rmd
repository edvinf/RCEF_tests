...
### Columns not included, with reserved status in IC (not in draft)
ICES secretariat has clarified that we can ignore these columns wrp to InterCatch compatibility.
* DepthRange
* Stock
* QualityFlag
* varCATON
